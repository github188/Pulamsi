 ...
 */
public class CommonListViewWrapperPost<T> extends RecyclerView.OnScrollListener implements  PtrHandler {
  ...
  public CommonListViewWrapperPost(Activity activity) {
    mActivity = activity;
  }

  public CommonListViewWrapperPost setListView(TRecyclerView listView) {
    mListView = listView;
    return this;
  }

  public CommonListViewWrapperPost setLayoutManager(StaggeredGridLayoutManager layoutManager) {
    mLayoutManager = layoutManager;
    return this;
  }

  public CommonListViewWrapperPost setListAdapter(HaiBaseListAdapter adapter) {
    mListAdapter = adapter;
    return this;
  }
  public CommonListViewWrapperPost setProgressWheel(ProgressWheel progressWheel) {
    this.progressWheel = progressWheel;
    return this;
  }

  public CommonListViewWrapperPost setLoadMoreHandler(CommonListLoadMoreHandler loadMoreHandler) {
    mLoadMoreHandler = loadMoreHandler;
    mIsLoadMoreOpen = true;
    return this;
  }

  public CommonListViewWrapperPost setPtrStylelFrameLayout(PtrStylelFrameLayout ptrStylelFrameLayout) {
    this.ptrStylelFrameLayout = ptrStylelFrameLayout;
    mIsPullToRefreshOpen = true;
    return this;
  }

  public CommonListViewWrapperPost setRequestListener(RequestListener requestListener) {
    mRequestListener = requestListener;
    return this;
  }

  public CommonListViewWrapperPost setOnScrollListener(OnScrollListener onScrollListener) {
    ...
    StringRequest dataRequest = new StringRequest(Request.Method.POST,
      ...
      public void onResponse(String result) {
        if (result != null) {
          try {
            Gson gson = new Gson();
            List<T> lists = gson.fromJson(result, new TypeToken<List<T>>() {}.getType());
