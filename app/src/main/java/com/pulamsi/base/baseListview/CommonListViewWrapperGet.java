 ...
 */
public class CommonListViewWrapperGet<T> extends RecyclerView.OnScrollListener
    implements TRecyclerView.OnItemClickListener, PtrHandler {

  private static final String TAG = CommonListViewWrapperGet.class.getSimpleName();
  ...
  public CommonListViewWrapperGet(Activity activity) {
    mActivity = activity;
  }

  public CommonListViewWrapperGet setListView(TRecyclerView listView) {
    mListView = listView;
    return this;
  }

  public CommonListViewWrapperGet setLayoutManager(StaggeredGridLayoutManager layoutManager) {
    mLayoutManager = layoutManager;
    return this;
  }

  public CommonListViewWrapperGet setListAdapter(HaiBaseListAdapter adapter) {
    mListAdapter = adapter;
    return this;
  }
  public CommonListViewWrapperGet setProgressWheel(ProgressWheel progressWheel) {
    this.progressWheel = progressWheel;
    return this;
  }

  public CommonListViewWrapperGet setLoadMoreHandler(CommonListLoadMoreHandler loadMoreHandler) {
    mLoadMoreHandler = loadMoreHandler;
    mIsLoadMoreOpen = true;
    return this;
  }

  public CommonListViewWrapperGet setPtrStylelFrameLayout(PtrStylelFrameLayout ptrStylelFrameLayout) {
  ...
  public CommonListViewWrapperGet setOnScrollListener(OnScrollListener onScrollListener) {
...
//              PulamsiApplication.context.getResources().getDimensionPixelOffset(R.dimen.home_recommend_list_item_height) * data.size()/2;
   ...
   * 接口参考 {@link android.support.v7.widget.RecyclerView.OnScrollListener}
   */
