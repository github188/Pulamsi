...
public class GoodDetailGoodImageDetailFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        String mDescurl = getString(R.string.serverbaseurl)+ getString(R.string.showIntroduction)+ "?sn=" + angelProductBean.getSn();
    ...
    public void onNotifyImgDetailChangeWebViewEvent(GoodDetailImgDetailTabFragment.NotifyImgDetailChangeWebViewEvent event) {
        ...
        if (tabPos == 0) {
            ...
            if (!isProductParamWebViewLoad && angelProductBean != null) {
                String productParamurl = getString(R.string.serverbaseurl)+ getString(R.string.showParameter)+ "?sn=" + angelProductBean.getSn();
            ...
            if (!isshowHelpWebViewLoad && angelProductBean != null) {
