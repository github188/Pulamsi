        ...
        rightTetxtView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("".equals(et_email.getText().toString())){
                    ToastUtil.toastShow(PulamsiApplication.context, "姓名不能为空！");
                    return;
                }
                BusProvider.getInstance().post(new MessageEvent(et_email.getText().toString(),"name"));
                finish();
            }
        });
    }
