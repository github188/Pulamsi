...
public class SliderBanner extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray arr = context.obtainStyledAttributes(attrs, in.srain.cube.R.styleable.SliderBanner, 0, 0);
...
//        mViewPager.setPageTransformer(true, new DepthPageTransformer());
        mPagerIndicator = (DotContainer) findViewById(mResIdForIndicator);
