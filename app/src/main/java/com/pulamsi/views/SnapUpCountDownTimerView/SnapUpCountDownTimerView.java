...
package com.pulamsi.views.SnapUpCountDownTimerView;
...
public class SnapUpCountDownTimerView extends LinearLayout {
    ...
    public SnapUpCountDownTimerView(Context context, AttributeSet attrs) {
        ...
        ll_rootview = (LinearLayout) view.findViewById(R.id.ll_rootview);
...
//                                        Toast.LENGTH_SHORT).show();
                                stop();
                                setTime(0, 0, 0);//重置为0
                                BusProvider.getInstance().post(new MessageEvent("complete"));
                            }
                        }
                    }
                }
