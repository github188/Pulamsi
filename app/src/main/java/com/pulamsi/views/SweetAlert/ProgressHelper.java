package com.pulamsi.views.SweetAlert;

import android.content.Context;

import com.pnikosis.materialishprogress.ProgressWheel;

import static com.pulamsi.R.color;
import static com.pulamsi.R.dimen;
...
public class ProgressHelper {
    ...
    public ProgressHelper(Context ctx) {
        mToSpin = true;
        mSpinSpeed = 0.75f;
        mBarWidth = ctx.getResources().getDimensionPixelSize(dimen.common_circle_width) + 1;
        mBarColor = ctx.getResources().getColor(color.success_stroke_color);
        mRimWidth = 0;
        mRimColor = 0x00000000;
        mIsInstantProgress = false;
        mProgressVal = -1;
        mCircleRadius = ctx.getResources().getDimensionPixelOffset(dimen.progress_circle_radius);
    }
