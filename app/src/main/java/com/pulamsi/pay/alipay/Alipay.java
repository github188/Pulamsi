...
//                        ToastUtil.toastShow(com.pulamsi.constant.Constants.choicePayTypeActivity, "取消支付");
//                    } else {
//                        // 判断resultStatus 为非“9000”则代表可能支付失败
//                        // “8000”代表支付结果因为支付渠道原因或者系统原因还在等待支付结果确认，最终交易是否成功以服务端异步通知为准（小概率状态）
//                        if (TextUtils.equals(resultStatus, "8000")) {
//                            ToastUtil.toastShow(com.pulamsi.constant.Constants.choicePayTypeActivity, "支付结果确认中");
//                        } else {
...
//                    }
                ...
                case SDK_CHECK_FLAG: {
//				Toast.makeText(Alipay.this, "检查结果为：" + msg.obj,
//						Toast.LENGTH_SHORT).show();
     ...
     */
    public void alipay(final Context context, String buyOrderInfo, String price, String orderNum, String productNameName) {
        this.price = price;
        this.orderNum = orderNum;
        this.productName = productNameName;
