 ...
 *
 */
public class HomeMoreGoodsWrapperGet extends RecyclerView.OnScrollListener
    implements TRecyclerView.OnItemClickListener, PtrHandler {

  private static final String TAG = HomeMoreGoodsWrapperGet.class.getSimpleName();
  ...
  /** 列表对应数据适配器 */
  private HaiBaseListAdapter<HotSellProduct> mListAdapter;
  ...
  public HomeMoreGoodsWrapperGet(Activity activity) {
    mActivity = activity;
  }

  public HomeMoreGoodsWrapperGet setListView(TRecyclerView listView) {
    mListView = listView;
    return this;
  }

  public HomeMoreGoodsWrapperGet setLayoutManager(StaggeredGridLayoutManager layoutManager) {
    mLayoutManager = layoutManager;
    return this;
  }

  public HomeMoreGoodsWrapperGet setListAdapter(HaiBaseListAdapter adapter) {
    mListAdapter = adapter;
    return this;
  }
  public HomeMoreGoodsWrapperGet setProgressWheel(ProgressWheel progressWheel) {
    this.progressWheel = progressWheel;
    return this;
  }

  public HomeMoreGoodsWrapperGet setLoadMoreHandler(CommonListLoadMoreHandler loadMoreHandler) {
    mLoadMoreHandler = loadMoreHandler;
    mIsLoadMoreOpen = true;
    return this;
  }

  public HomeMoreGoodsWrapperGet setPtrStylelFrameLayout(PtrStylelFrameLayout ptrStylelFrameLayout) {
  ...
  public HomeMoreGoodsWrapperGet setOnScrollListener(OnScrollListener onScrollListener) {
  ...
  private void getData(String url, final Map<String, String> bizParams) {
   String URL1 = url + "?productName=" + "&pageNumber=" + bizParams.get("pageNumber") + "&pageSize=10&searchProperty=&searchValue=";
    StringRequest dataRequest = new StringRequest(Request.Method.GET,
      ...
      public void onResponse(String result) {
        if (result != null) {
          try {
            Gson gson = new Gson();
           SearchGoodsList temp = gson.fromJson(
                    result, SearchGoodsList.class);
            updateListData(temp.getList());
          } catch (Exception e) {
          }
        }
      }
  ...
  public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
    ...
    if (mIsLoadMoreOpen) {
      if (newState == RecyclerView.SCROLL_STATE_IDLE) {
        ...
        HaiLog.d(TAG, "滚动到最后一排元素：" + lastVisibleItemPosition);
  ...
  public void onRefreshBegin(PtrFrameLayout frame) {
    ...
    mListAdapter.notifyItemRangeRemoved(1, itemCount);
